...
const BurgerCard = ({ title, image, price, review }: Props) => {
  return (
    <div className="bg-white p-6 rounded-lg m-3">
      ...
      <p className="mt-[0.5rem] text-black text-opacity-80">
        Что-то на богатом и вкусно пахнущем
      </p>
      <div className="flex mt-[1.4rem] items-center justify-between">
        <h1 className="text-[25px] font-bold text-red-600">{price} ₽</h1>
        <button className="px-4 py-2 hover:bg-green-700 transition-all duration-200 bg-yellow-600 flex items-center rounded-md text-white">
          <BiShoppingBag />
        </button>
      </div>
    </div>
